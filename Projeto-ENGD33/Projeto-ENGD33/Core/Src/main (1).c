...
//  separar as chamadas de inicialização de
//  periféricos, filas e tarefas em funções distintas

void InicializarPerifericos(void) {
    MX_GPIO_Init();
    MX_RTC_Init();
    MX_ADC1_Init();
    MX_I2C1_Init();
...
int main(void) {
    ...
    SetupTarefasPortaCOMM();  // Cria filas, inicia UART com interrupção e tasks
    osKernelInitialize();
    osKernelStart();
    while (1) {}
}
